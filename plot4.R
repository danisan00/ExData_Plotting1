...
buildPlot <- function(data) {
  ...
  legend("topright", lwd = 1, bty = "n", col = c(rgb(12, 12, 12, maxColorValue = 255), rgb(255, 37, 0, maxColorValue = 255), rgb(4, 51, 255, maxColorValue = 255)), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
